...
$(document).ready(function() {
    ...
    let notifications = [
        { id: 1, message: "New booking request from Jane Doe.", read: false },
        { id: 2, message: "Payment received from Juan Dela Cruz.", read: false },
        { id: 3, message: "Booking #1234 has been accepted.", read: true },
        { id: 4, message: "User Maria Santos updated her profile.", read: false }
    ];
